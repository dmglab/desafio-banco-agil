...
Agente de Triagem: Porta de entrada obrigatória. Bloqueia o atendimento na 3ª falha consecutiva.

Agente de Crédito: Avalia propostas contra tabelas de risco. Grava logs sob a normativa ISO 8601 (UTC/Z).

Agente de Entrevista: Executa uma sub-máquina de estados sequencial isolada para cálculo de score.

Agente de Câmbio: Atende requisições de mercado e encerra o ciclo.
...
Se houver qualquer outro ponto que não tenha ficado exatamente como você pediu, por favor, me indique e farei o ajuste imediato.
