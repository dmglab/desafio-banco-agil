...
* clientes.csv: Base de identificação e scores.
* score_limite.csv: Tabela estática de limites.
* solicitacoes_aumento_limite.csv: Registro Append-Only em padrão ISO 8601.
...
**Persistência:** O sistema utiliza pandas para ler os arquivos CSV diretamente na raiz do projeto, garantindo compatibilidade total com qualquer ambiente de execução.
